...
export default async () => {
  ...
  return defineConfig({
    root: __dirname,
    cacheDir: '../../../node_modules/.vite/libs/list/utils',
    ...
    // Library build configuration (Vite library mode)
    build: {
      outDir: '../../../dist/libs/list/utils',
      emptyOutDir: true,
      ...
      rollupOptions: {
        // Add external deps here if you don't want them bundled
        external: [],
      },
    },

    // Vitest configuration for this library
    test: {
      name: 'utils',
      watch: false,
      globals: true,
      ...
      reporters: ['default'],
      coverage: {
        reportsDirectory: '../../../coverage/libs/list/utils',
